...
//                 Units.inchesToMeters(8.5), 1.435, Units.degreesToRadians(-30), Units.degreesToRadians(target.getYaw()));
//             } else if (targetSide == "right") { //right
//               targetRange =
//               PhotonUtils.calculateDistanceToTargetMeters(
//                 Units.inchesToMeters(8.5), 1.435, Units.degreesToRadians(-30), Units.degreesToRadians(target.getYaw()));
//             } else{ //middle
...
//     if (controller.povDown().getAsBoolean() || controller.povLeft().getAsBoolean() || controller.povRight().getAsBoolean() && targetVisible){
