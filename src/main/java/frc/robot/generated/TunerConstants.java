...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(Constants.STEER_P_VALUE).withKI(0).withKD(Constants.STEER_D_VALUE)
        .withKS(Constants.STEER_S_VALUE).withKV(0).withKA(0)
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.16455078125);
    private static final boolean kBackLeftSteerMotorInverted = true;
    private static final boolean kBackLeftEncoderInverted = false;

    private static final Distance kBackLeftXPos = Inches.of(-8.5);
    ...
    private static final Distance kBackRightXPos = Inches.of(-8.5);
